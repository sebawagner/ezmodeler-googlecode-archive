...
public class Install extends VelocityViewServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 58864442123058172L;
	...
	public Template handleRequest(HttpServletRequest httpServletRequest,
		...
		try {
			...
			String working_dir = getServletContext().getRealPath("/")
					+ Application.configDirName + File.separatorChar;
			...
			if (command == null) {
				...
				if (!installerFile.exists()) {
					...
					if (!b) {
						...
						InstallationDocumentHandler.createDocument(working_dir
								+ InstallationDocumentHandler.installFileName,
								0);
					...
					int i = InstallationDocumentHandler
							.getCurrentStepNumber(working_dir);
					if (i == 0) {
						String filePath = getServletContext().getRealPath("/")
								+ IImportInitvalues.languageFolderName;
						LinkedHashMap<Integer, String> allLanguages = importInitvalues
